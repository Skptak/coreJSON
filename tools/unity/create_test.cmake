...
function(create_test test_name test_src link_list dep_list include_list)
  include(CTest)
  ...
  target_include_directories(${test_name} PUBLIC ${include_list})
...
function(create_real_library target src_file real_include_list)
  add_library(${target} STATIC ${src_file})
  target_include_directories(${target} PUBLIC ${real_include_list})
  set_target_properties(
    ${target}
    PROPERTIES COMPILE_FLAGS "-Wextra -Wpedantic \
